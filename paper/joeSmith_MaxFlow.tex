...
The greedy algorithm is one which may seem to be effective at first, but turns out to have greater costs associated with it than initially apparent.

\section{Ford-Fulkerson Algorithm}
The Ford-Fulkerson algorithm is actually 
